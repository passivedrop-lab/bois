"use strict";(()=>{var e={};e.id=830,e.ids=[830],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},1687:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>m,patchFetch:()=>x,requestAsyncStorage:()=>p,routeModule:()=>d,serverHooks:()=>l,staticGenerationAsyncStorage:()=>c});var o={};r.r(o),r.d(o,{POST:()=>i});var a=r(9303),s=r(8716),n=r(3131),u=r(7070);async function i(e){try{let{orderId:t,status:r,reason:o}=await e.json();if(!t||!r)return u.NextResponse.json({error:"Param\xe8tres manquants"},{status:400});let a="",s="";return"verified"===r?(a=`Votre commande #${t} a \xe9t\xe9 valid\xe9e`,s=`
Bonjour,
