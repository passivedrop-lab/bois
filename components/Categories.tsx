...
const categories = [
  ...
  },
  {
    ...
    href: '/katalog/materialy-dlya-bani',
    icon: Wrench,
  ...
  },
  {
    ...
    href: '/katalog/dekorativnaya-otdelka',
    icon: Palette,
  ...
  },
  {
    ...
    href: '/katalog/tekhnicheskoe-derevo',
    icon: Shield,
