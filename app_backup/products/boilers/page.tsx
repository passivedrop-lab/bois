        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-fire-500/20 backdrop-blur-sm rounded-full p-4 mb-6">
              <Wrench size={48} className="text-fire-400" />
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-6">
              Котлы на твердом топливе
            </h1>
            <p className="text-xl md:text-2xl text-wood-200">
              Эффективные котлы для автономного отопления
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="card-premium p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-wood-900 mb-2">Высокая мощность</h3>
            <p className="text-wood-600 text-sm">Для больших помещений</p>
          </div>
          <div className="card-premium p-6 text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-fire-500 to-fire-700 rounded-full flex items-center justify-center mx-auto mb-4">
              <Award className="text-white" size={32} />
            </div>
            <h3 className="text-lg font-semibold text-wood-900 mb-2">Надежность</h3>
            <p className="text-wood-600 text-sm">Долговечная конструкция</p>
          </div>
          <div className="card-premium p-6 text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-fire-500 to-fire-700 rounded-full flex items-center justify-center mx-auto mb-4">
              <Wrench className="text-white" size={32} />
            </div>
            <h3 className="text-lg font-semibold text-wood-900 mb-2">Автоматизация</h3>
            <p className="text-wood-600 text-sm">Удобное управление</p>
          </div>
          <div className="card-premium p-6 text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-fire-500 to-fire-700 rounded-full flex items-center justify-center mx-auto mb-4">
              <Truck className="text-white" size={32} />
            </div>
            <h3 className="text-lg font-semibold text-wood-900 mb-2">Установка</h3>
